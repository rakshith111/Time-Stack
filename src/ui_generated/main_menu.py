...
class Ui_MainMenu(object):
    def setupUi(self, MainMenu):
        ...
        MainMenu.resize(945, 500)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Maximum, QtWidgets.QSizePolicy.Policy.Maximum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(MainMenu.sizePolicy().hasHeightForWidth())
        MainMenu.setSizePolicy(sizePolicy)
        MainMenu.setMinimumSize(QtCore.QSize(945, 500))
        MainMenu.setMaximumSize(QtCore.QSize(945, 500))
        ...
        self.add_activity_m.setFont(font)
        ...
        font = QtGui.QFont()
        font.setPointSize(12)
        self.view_stack_m.setFont(font)
        self.view_stack_m.setObjectName("view_stack_m")
        self.h_btn_layout.addWidget(self.view_stack_m)
        self.settings_m = QtWidgets.QPushButton(parent=self.verticalLayoutWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Maximum, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.settings_m.sizePolicy().hasHeightForWidth())
        self.settings_m.setSizePolicy(sizePolicy)
        self.settings_m.setMinimumSize(QtCore.QSize(200, 30))
        self.settings_m.setMaximumSize(QtCore.QSize(200, 30))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.settings_m.setFont(font)
        self.settings_m.setObjectName("settings_m")
        self.h_btn_layout.addWidget(self.settings_m)
    ...
    def retranslateUi(self, MainMenu):
        ...
        self.settings_m.setText(_translate("MainMenu", "  Settings"))
