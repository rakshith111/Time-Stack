...
class Ui_MainMenu(object):
    def setupUi(self, MainMenu):
        ...
        MainMenu.resize(1020, 500)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Maximum, QtWidgets.QSizePolicy.Policy.Maximum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(MainMenu.sizePolicy().hasHeightForWidth())
        MainMenu.setSizePolicy(sizePolicy)
        MainMenu.setMinimumSize(QtCore.QSize(1020, 500))
        MainMenu.setMaximumSize(QtCore.QSize(1020, 550))
        ...
        self.toggle_theme = QtWidgets.QPushButton(parent=self.centralwidget)
        self.toggle_theme.setEnabled(True)
        self.toggle_theme.setGeometry(QtCore.QRect(950, 20, 60, 60))
        self.toggle_theme.setMinimumSize(QtCore.QSize(60, 60))
        self.toggle_theme.setMaximumSize(QtCore.QSize(60, 60))
